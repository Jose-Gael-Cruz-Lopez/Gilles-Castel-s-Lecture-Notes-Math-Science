...
% --- Page layout ---
% Use wide margins so text fills the page (1 inch on all sides)
% headheight=15pt fixes fancyhdr warning; marginparwidth fixes todonotes warning
\usepackage[margin=1in, headheight=15pt, marginparwidth=2.5cm]{geometry}
...
% --- Lecture/unit header command ---
% Usage: \lecture{1}{Mon 03 Feb 2025 10:00}{Introduction to Group Theory}
% The heading shows just "#1: #3" (no "Lecture" prefix), so you can use it
% for lectures, units, chapters, problem sets, etc.
\usepackage{xifthen}
\def\testdateparts#1{\dateparts#1\relax}
\def\dateparts#1 #2 #3 #4 #5\relax{
    \marginpar{\small\textsf{\parbox{2.3cm}{\raggedright #1 #2 #3 #5}}}
}
...
% Use only RO/LO (oneside-compatible) instead of RO/LE/RE/LO
\fancyhead[R]{\@lecture}
\fancyhead[L]{}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{}
...
% Suppress PDF page group warnings (only if the primitive exists)
